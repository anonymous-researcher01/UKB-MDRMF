...
print(dim(multimor_data))  # For 'Pred', it should be 1560 x 101; for 'Surv', it should be 1560 x 301
...
if (selected_methed == "Pred") {
  threshold <- 0.5  # For 'Pred'
} else if (selected_methed == "Surv") {
  threshold <- 0.62  # For 'Surv'
}
...
if (selected_methed == "Pred") {
  ## For 'Pred'
  ggsave("./results/cache/multimorbidity/top6_community_plot_th050.pdf",
         plot = combined_plot, width = 9, height = 7)
  ggsave("./results/cache/multimorbidity/top6_community_plot_th050.png",
         plot = combined_plot, width = 9, height = 7)
} else if (selected_methed == "Surv") {
  ## For 'Surv'
  ggsave("./results/cache/multimorbidity/top6_community_plot_th062_surv.pdf",
         plot = combined_plot, width = 9, height = 7)
  ggsave("./results/cache/multimorbidity/top6_community_plot_th062_surv.png",
         plot = combined_plot, width = 9, height = 7)
}