...
The parameters, weights, and intermediate results used for plotting are available on Zenodo. You can access them via the following link: [Model parameters and outcomes of "UKB-MDRMF: A Multi-Disease Risk & Multimorbidity Framework Based on UK Biobank Data"](https://sandbox.zenodo.org/records/73649).
